...
class ResNetBlock(nn.Module):
    ...
    def __init__(self, in_nc, mid_nc, out_nc, kernel_size=3, stride=1, \
        ...
        conv1 = conv_block(mid_nc, out_nc, kernel_size, stride, dilation, groups, \
                           bias, pad_type, norm_type, act_type, mode)
        # if in_nc != out_nc:
        #     self.project = conv_block(in_nc, out_nc, 1, stride, dilation, 1, \
        #                               bias, pad_type, None, None)
